...
void init();
extern void rtupdate0();
extern void rtupdate1();
extern void rtupdate2();
extern void rtupdate3();
...
void creatertpkt(initrtpkt, srcid, destid, mincosts) struct rtpkt *initrtpkt;
int srcid;
int destid;
int mincosts[];
...
void init() /* initialize the simulator */
{
  ...
  srand(9998); /* init random number generator */
